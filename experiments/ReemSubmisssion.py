...
if __name__ == '__main__':
    ...
    categorical_cols = ['gender', 'product', 'campaign_id', 'webpage_id', 'product_category_1', 'product_category_2']
    ...
    pipeline = BaseModelPipeline(
        ...
        steps=[
            ("encoder", RatioBasedLabelPreprocessor(
                label_features=['gender', 'product', 'campaign_id', 'webpage_id',
    ...
    print("Predicted CTR Rate:", y_pred.mean())
